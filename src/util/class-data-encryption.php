...
class Data_Encryption
{
    ...
    public function encrypt($value)
    {
        if (! extension_loaded('openssl')) {
            throw new Encryption_Exception(esc_html(Encryption_Exception::openssl_error()));
        }
        ...
        if (! $raw_value) {
            throw new Encryption_Exception(esc_html(Encryption_Exception::encrypt_error()));
        } else {
    ...
    public function decrypt($raw_value)
    {
        ...
        if (! extension_loaded('openssl')) {
            throw new Decryption_Exception(esc_html(Encryption_Exception::openssl_error()));
        }
        ...
        if (! $value || substr($value, - strlen($this->salt)) !== $this->salt) {
            throw new Decryption_Exception(esc_html(Decryption_Exception::decrypt_error()));
        } else {
