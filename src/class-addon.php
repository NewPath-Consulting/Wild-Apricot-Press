...
class Addon
{
     ...
     * @var string[]
     */
    public const FREE_ADDONS = array(0 => CORE_SLUG);
     ...
     * @var string
     */
    public const WAWP_LICENSE_KEYS_OPTION      = 'wawp_license_keys';
     ...
     * @var string
     */
    public const WAWP_ADDON_LIST_OPTION        = 'wawp_addons';

    /**
     * @var string prefix for the activation notice toggle option name
     */
    public const WAWP_ACTIVATION_NOTICE_OPTION = 'show_activation_notice';
    public const WAWP_DISABLED_OPTION          = 'wawp_disabled';
     ...
     * License key entered.
     */
    public const LICENSE_STATUS_VALID          = 'true';
     ...
     * @var string
     */
    public const LICENSE_STATUS_ENTERED_EMPTY  = 'empty';
     ...
     * @var string
     */
    public const LICENSE_STATUS_NOT_ENTERED    = 'false';
     ...
     * @var string
     */
    public const LICENSE_STATUS_AUTH_CHANGED   = 'auth_changed';
    ...
    public static function license_admin_notices()
    {
        ...
        foreach (self::get_addons() as $slug => $data) {
            ...
            if (license_submitted()) {
                ...
                } elseif ($license_status == self::LICENSE_STATUS_ENTERED_EMPTY) {
            ...
            if ($is_plugin_page && !$should_show_activation_notice) {
                continue;
            }
            ...
            } elseif ($license_status == self::LICENSE_STATUS_INVALID) {
                // show invalid license message on any wawp settings page
                self::invalid_license_key_notice($slug);
            } elseif ($license_status == self::LICENSE_STATUS_AUTH_CHANGED) {
    ...
    public static function validate_license_key($license_key_input, $addon_slug)
    {
        ...
        if (empty($license_key_input)) {
            return self::LICENSE_STATUS_ENTERED_EMPTY;
        }
        ...
        if ($license_key != $license_key_input) {
            return null;
        }
